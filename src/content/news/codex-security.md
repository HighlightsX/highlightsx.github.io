...
description: "Codex Security is a CLI and SDK that finds, validates and fixes vulnerabilities, and can run the scan through OpenRouter, Bedrock or Fireworks instead."
